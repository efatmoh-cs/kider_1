    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav mx-auto">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu rounded-0 rounded-bottom border-0 shadow-sm m-0">
                    <a href="{{route('classes')}}" class="dropdown-item">All Classes</a>
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu rounded-0 rounded-bottom border-0 shadow-sm m-0">
                    <a href="{{route('testimoinals')}}" class="dropdown-item">All Testimonials</a>
                    <a href="{{route('createtestimoinal')}}" class="dropdown-item">Add new Testimonial</a>
                </div>
            </div>
